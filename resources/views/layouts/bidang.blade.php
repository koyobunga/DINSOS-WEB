...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>DINSOS | {{ Auth::user()->bidang->nama }}</title>
    ...
    <body data-topbar="dark">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="dropdown d-inline-block">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <a class="dropdown-item text-danger" href="{{ url('bidang/signout')}}"><i class="bx bx-power-off font-size-16 align-middle mr-1 text-danger"></i> Logout</a>
                            </div>
                        </div>

                        <div class="text-white h-100 py-4 mr-2" >
                            {{ Auth::user()->name }}
                                              </div>
                ...
                <div data-simplebar class="h-100">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                <a href="{{ url('bidang') }}" class="waves-effect">
                            ...
                            <li>
                                <a href="{{ url('bidang/galeris')}}" class="waves-effect">
                            ...
                            <li>
                                <a href="{{ url('bidang/beritas')}}" class="waves-effect">
                ...
                <div class="modal fade" id="passModal" tabindex="-1" role="dialog" aria-labelledby="passModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-content">
                        <form action="">
                            ...
                            <h5 class="modal-title" id="passModalLabel">Ubah Pasword</h5>
        ...
        <script src="{{ url('assets/admin/js/pages/ecommerce-select2.init.js') }}"></script>
