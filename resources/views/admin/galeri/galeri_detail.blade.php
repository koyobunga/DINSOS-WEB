...
<div class="card p-4">
  ...
  <form action="{{ url('admin/galeri_dets') }}" method="POST" enctype="multipart/form-data">
    @method('post')
    @csrf
    ...
    <div class="input-group">
      ...
      <a href="{{ url('admin/galeris') }}" class="btn btn-secondary"> Kembali </a>
    ...
    <div class="col-lg-2 col-md-4 mt-4">
      <div class="card me-3 mb-3 position-relative shadow-sm h-100">
        ...
        <div class="position-absolute bottom-0 end-0 mb-2 me-2">
          <form action="{{ url('admin/galeri_dets/'.$d->id) }}" method="POST">
            @csrf
            @method('delete')
