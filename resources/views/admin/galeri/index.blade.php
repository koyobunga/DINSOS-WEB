...
<div class="card p-4">
    ...
    <form action="{{ url('admin/galeris') }}" method="POST">
        @method('post')
        @csrf
        <div class="">
            <div class="w-100">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="d-flex text-end">
                        <a href="{{ url('admin/galeri_det/'.$d->id) }}" class="btn btn-success btn-sm mr-3"><i class="mdi mdi-image-plus"></i></a>
                        ...
                        <form action="{{ url('admin/galeris/'.$d->id) }}" method="POST">
                            @csrf
                            @method('delete')
...
<div id="modal_edit" class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <form action="{{ url('admin/galeri/editlabel') }}" method="POST">
        @method('post')
        @csrf
