...
<div class="card p-4">
  ...
  <form action="{{ url('bidang/asets') }}" method="POST" enctype="multipart/form-data">
    @method('post')
    @csrf
    <div class="mb-3 row">
      <div class="col-lg-3">
        <label for="exampleInputEmail1" class="form-label">Kode</label>
        <input required readonly name="kode" value="{{ old('kode', $kode)}}" type="text" class="form-control @error('kode') is-invalid @enderror">
        @error('kode')
      ...
      <div class="col-lg-6">
        ...
        <div class="input-group">
          <select required name="item_id" class="form-control select2" id="inputGroupSelect04">
            ...
            @foreach ($item as $i)
              <option @if(old('item_id') == $i->id) selected @endif value="{{ $i->id }}">{{ $i->nama }}</option>
            @endforeach
          </select>
      ...
      <div class="col-lg-3">
        ...
        <input required name="merk" value="{{ old('merk')}}" type="text"
    ...
    <div class="mb-3 row">
      <div class="col-lg-3">
        ...
        <input required name="satuan" value="{{ old('satuan')}}" type="text"
      ...
      <div class="col-lg-3">
        ...
        <input required name="jumlah" value="{{ old('jumlah', 1)}}" type="number"
      ...
      <div class="col-lg-3">
        ...
        <input required name="bapp" value="{{ old('bapp', 1)}}" type="date"
      ...
      <div class="col-lg-3">
        ...
        <select required name="kondisi" required class="form-control @error('kondisi') is-invalid @enderror"
          ...
          <option @if(old('kondisi') == 'Baik') selected @endif value="Baik">Baik</option>
          <option @if(old('kondisi') == 'Cukup Baik') selected @endif value="Cukup Baik">Cukup Baik</option>
          <option @if(old('kondisi') == 'Rusak') selected @endif value="Rusak">Rusak</option>
          <option @if(old('kondisi') == 'Baik Ringan') selected @endif value="Rusak Ringan">Rusak Ringan</option>
          <option @if(old('kondisi') == 'Rusak Berat') selected @endif value="Rusak Berat">Rusak Berat</option>
        </select>
        @error('kondisi')
        <div class="invalid-feedback">
          {{ $message }}
