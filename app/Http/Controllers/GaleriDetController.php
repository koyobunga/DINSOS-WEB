...
use App\Http\Requests\StoreGaleri_detRequest;
use App\Http\Requests\UpdateGaleri_detRequest;
use App\Models\Galeri;
use Illuminate\Http\Request;

class GaleriDetController extends Controller
{
    public function index(Galeri $galeri)
    {
        return view('admin.galeri.galeri_detail',[
     ...
     */
    public function update(UpdateGaleri_detRequest $request, Galeri_det $galeri_det)
    {
        //
    }
